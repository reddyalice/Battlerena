...
public class NatureSpirit extends Skill {

	public NatureSpirit() {
		super("Spirit of the Nature", new TextureHolder(Assets.GetTexture("icon_natureSpirit")), null, 
				1, 0, 0, "Nature is kinda friendly.");
